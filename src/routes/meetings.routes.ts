...
meetingsRouter.get("/:id/media", meetingController.getMeetingMedia);
meetingsRouter.post("/:id/media/presign", meetingController.presignMeetingMedia);
meetingsRouter.delete("/:id/media", meetingController.deleteMeetingMedia);
